...
abstract class AbstractBodyTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<body', $renderedTag);
        $this->assertStringContainsString('onafterprint', $renderedTag);
        $this->assertStringContainsString('onbeforeprint', $renderedTag);
        $this->assertStringContainsString('onbeforeunload', $renderedTag);
        $this->assertStringContainsString('onerror', $renderedTag);
        $this->assertStringContainsString('onhashchange', $renderedTag);
        $this->assertStringContainsString('onload', $renderedTag);
        $this->assertStringContainsString('onoffline', $renderedTag);
        $this->assertStringContainsString('ononline', $renderedTag);
        $this->assertStringContainsString('onpagehide', $renderedTag);
        $this->assertStringContainsString('onpageshow', $renderedTag);
        $this->assertStringContainsString('onpopstate', $renderedTag);
        $this->assertStringContainsString('onresize', $renderedTag);
        $this->assertStringContainsString('onstorage', $renderedTag);
        $this->assertStringContainsString('onunload', $renderedTag);
