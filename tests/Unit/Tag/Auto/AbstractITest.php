...
use WabLab\HtmlBuilder\HTML\Tag\I;

abstract class AbstractITest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<i', $renderedTag);
