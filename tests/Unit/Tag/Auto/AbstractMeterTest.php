...
abstract class AbstractMeterTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<meter', $renderedTag);
        $this->assertStringContainsString('form', $renderedTag);
        $this->assertStringContainsString('high', $renderedTag);
        $this->assertStringContainsString('low', $renderedTag);
        $this->assertStringContainsString('max', $renderedTag);
        $this->assertStringContainsString('min', $renderedTag);
        $this->assertStringContainsString('optimum', $renderedTag);
