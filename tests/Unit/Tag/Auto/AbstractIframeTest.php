...
abstract class AbstractIframeTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<iframe', $renderedTag);
        ...
        $this->assertStringContainsString('sandbox', $renderedTag);
        $this->assertStringContainsString('src', $renderedTag);
        $this->assertStringContainsString('srcdoc', $renderedTag);
