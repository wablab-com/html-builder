...
abstract class AbstractFormTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('accept-charset', $renderedTag);
        $this->assertStringContainsString('action', $renderedTag);
        $this->assertStringContainsString('autocomplete', $renderedTag);
        $this->assertStringContainsString('enctype', $renderedTag);
        $this->assertStringContainsString('method', $renderedTag);
        $this->assertStringContainsString('name', $renderedTag);
        $this->assertStringContainsString('novalidate', $renderedTag);
        $this->assertStringContainsString('onreset', $renderedTag);
        $this->assertStringContainsString('onsubmit', $renderedTag);
        $this->assertStringContainsString('rel', $renderedTag);
        $this->assertStringContainsString('target', $renderedTag);
