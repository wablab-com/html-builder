...
use WabLab\HtmlBuilder\HTML\Tag\Small;

abstract class AbstractSmallTest extends AbstractTestCase
{

    protected Small $tagObj;
    

    function setUp(): void
    {
        parent::setUp();
        $this->tagObj = Small::create();
    }
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<small', $renderedTag);
