...
abstract class AbstractDetailsTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<details', $renderedTag);
        $this->assertStringContainsString('ontoggle', $renderedTag);
        $this->assertStringContainsString('open', $renderedTag);
