...
abstract class AbstractThTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<th', $renderedTag);
        $this->assertStringContainsString('colspan', $renderedTag);
        $this->assertStringContainsString('headers', $renderedTag);
        $this->assertStringContainsString('rowspan', $renderedTag);
        $this->assertStringContainsString('scope', $renderedTag);
