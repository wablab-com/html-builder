...
use WabLab\HtmlBuilder\HTML\Tag\Del;

abstract class AbstractDelTest extends AbstractTestCase
{

    protected Del $tagObj;
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<del', $renderedTag);
        $this->assertStringContainsString('cite', $renderedTag);
        $this->assertStringContainsString('datetime', $renderedTag);
