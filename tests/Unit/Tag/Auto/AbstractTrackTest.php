...
abstract class AbstractTrackTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<track', $renderedTag);
        $this->assertStringContainsString('default', $renderedTag);
        $this->assertStringContainsString('kind', $renderedTag);
        $this->assertStringContainsString('label', $renderedTag);
        $this->assertStringContainsString('oncuechange', $renderedTag);
        $this->assertStringContainsString('src', $renderedTag);
        $this->assertStringContainsString('srclang', $renderedTag);
