...
abstract class AbstractAreaTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<area', $renderedTag);
        $this->assertStringContainsString('alt', $renderedTag);
        $this->assertStringContainsString('coords', $renderedTag);
        $this->assertStringContainsString('download', $renderedTag);
        $this->assertStringContainsString('href', $renderedTag);
        $this->assertStringContainsString('hreflang', $renderedTag);
        $this->assertStringContainsString('media', $renderedTag);
        $this->assertStringContainsString('rel', $renderedTag);
        $this->assertStringContainsString('shape', $renderedTag);
