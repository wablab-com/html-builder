...
abstract class AbstractMetaTest extends AbstractTestCase
{
    ...
    public function testTagBasicRenderer() {
        ...
        $this->assertStringContainsString('<meta', $renderedTag);
        $this->assertStringContainsString('charset', $renderedTag);
        $this->assertStringContainsString('content', $renderedTag);
        $this->assertStringContainsString('http-equiv', $renderedTag);
